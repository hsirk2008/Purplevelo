(function () {
  ...
  {
  const a1 = annotate(document.querySelector('#e1'), { type: 'underline', color: '#B2CEDE' });
const a2 = annotate(document.querySelector('#e2'), { type: 'highlight', color: '#B2CEDE' });
const a3 = annotate(document.querySelector('#e3'), { type: 'highlight', color: '#B2CEDE' });
const a4 = annotate(document.querySelector('#e4'), { type: 'strike-through', color: '#B2CEDE'});
const a5 = annotate(document.querySelector('#e5'), { type: 'circle', color: '#B2CEDE'});
