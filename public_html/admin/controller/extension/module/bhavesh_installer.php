<?php
class ControllerExtensionModuleBhaveshInstaller extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->load->language('extension/module/bhavesh_installer');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/bhavesh_installer', $token_prefix . '=' . $this->session->data[$token_prefix], true)
		);
		...
		$this->response->setOutput($this->load->view('extension/module/bhavesh_installer', $data));
	}
	
	
	public function install() {
		// ##################################
		// Add Bhavesh Modification
		// ##################################
        
		if ((float)VERSION >= 3.0) {
		$this->load->model('setting/modification');
		$modification_prefix = 'model_setting_modification';
		$xml = file_get_contents(DIR_APPLICATION . '/view/javascript/bhavesh/main_ocmod/bhavesh_theme_3X.ocmod.xml');
		} else {
		$this->load->model('extension/modification');
		$modification_prefix = 'model_extension_modification';
		$xml = file_get_contents(DIR_APPLICATION . '/view/javascript/bhavesh/main_ocmod/bhavesh_theme_23.ocmod.xml');
		}
		...
		$data = array(
            ...
            'code' => 'bhavesh_theme',
			'id' => 'bhavesh_theme',
			'extension_install_id' => 'bhavesh_theme',
		...
		$mod = $this->$modification_prefix->getModificationByCode('bhavesh_theme');
        if (!$mod) {
		...
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/bhavesh/bhavesh');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/bhavesh/bhavesh');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/bhavesh/product_tabs');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/bhavesh/product_tabs');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/bhavesh/productgroups');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/bhavesh/productgroups');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/bhavesh/question');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/bhavesh/question');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/bhavesh/subscriber');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/bhavesh/subscriber');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/bhavesh/testimonial');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/bhavesh/testimonial');
		...
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/bhavesh_carousel');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/bhavesh_carousel');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/bhavesh_categories');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/bhavesh_categories');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/bhavesh_content');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/bhavesh_content');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/bhavesh_instagram');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/bhavesh_instagram');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/bhavesh_layerslider');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/bhavesh_layerslider');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/bhavesh_megamenu');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/bhavesh_megamenu');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/bhavesh_products');
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/bhavesh_products');
