<?php
class ControllerExtensionModuleBhaveshLayerslider extends Controller {
	private $error = array();
	public function index() {
		...
		$this->load->language('extension/module/bhavesh_layerslider');
		$this->document->setTitle($this->language->get('heading_title'));
		$this->document->addStyle('view/javascript/bhavesh/layerslider.css');
		...
		$this->document->addScript('view/javascript/bhavesh/js/removeclasses.js');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				$this->$model_module_path->addModule('bhavesh_layerslider', $this->request->post);
			} else {
			...
			if (isset($this->request->post['save']) && $this->request->post['save'] == 'stay' && $this->request->get['module_id']) {
				$this->response->redirect($this->url->link('extension/module/bhavesh_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix] . '&module_id=' . $this->request->get['module_id'], true)); 
			} else {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/bhavesh_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix], true)
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/bhavesh_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix] . '&module_id=' . $this->request->get['module_id'], true)
			);			
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/bhavesh_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix], true);
		} else {
			$data['action'] = $this->url->link('extension/module/bhavesh_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix] . '&module_id=' . $this->request->get['module_id'], true);
		}
		...
		$this->document->addStyle('http://fonts.googleapis.com/css?family=' . $bhavesh_font['import']);
		...
		if ($this->config->get('bhavesh_design_status')) {
			$data['contrast_color'] = $this->config->get('bhavesh_contrast_btn_bg');
		}
		...
		$this->response->setOutput($this->load->view('extension/module/bhavesh_layerslider', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/bhavesh_layerslider')) {
