<?php 
class ControllerExtensionBhaveshProductgroups extends Controller {
	private $error = array(); 
	...
	public function index() {
		...
		$this->load->language('bhavesh/productgroups');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/bhavesh/productgroups', $token_prefix . '=' . $this->session->data[$token_prefix], true)); 
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/bhavesh/productgroups', $token_prefix . '=' . $this->session->data[$token_prefix], true)
		);			
		

		$data['action'] = $this->url->link('extension/bhavesh/productgroups', $token_prefix . '=' . $this->session->data[$token_prefix], true);
		...
		$this->response->setOutput($this->load->view('extension/bhavesh/productgroups', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/bhavesh/productgroups')) {
