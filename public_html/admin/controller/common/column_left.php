		...
		/*	if ($this->user->hasPermission('access', 'catalog/attribute')) {
			...
			if ($this->user->hasPermission('access', 'catalog/information')) {		
				$catalog[] = array(
					...
					if ($this->user->hasPermission('access', 'extension/module/bhavesh_megamenu')) {		
				$catalog[] = array(
					'name'	   => 'Mega Menu',
					'href'     => $this->url->link('extension/module/bhavesh_megamenu', 'token=' . $this->session->data['token'] . '&module_id=32', true),
					'children' => array()		
				);					
			}
		...
		if ($this->user->hasPermission('access', 'design/banner')) {
				$catalog[] = array(
					...
					'children' => array()		
								...
								if ($this->user->hasPermission('access', 'extension/module/bhavesh_content')) {		
				$catalog[] = array(
					'name'	   => 'Home Blocks1',
					'href'     => $this->url->link('extension/module/bhavesh_content', 'token=' . $this->session->data['token'] . '&module_id=75', true),
					'children' => array()		
				);					
			}
				...
				$catalog[] = array(
					'name'	   => 'Home Blocks2',
					'href'     => $this->url->link('extension/module/bhavesh_content', 'token=' . $this->session->data['token'] . '&module_id=59', true),
					'children' => array()		
				);					
			}
				...
				$catalog[] = array(
					'name'	   => 'Home Blocks3',
					'href'     => $this->url->link('extension/module/bhavesh_content', 'token=' . $this->session->data['token'] . '&module_id=64', true),
					'children' => array()		
				);					
			}
				...
				$catalog[] = array(
					'name'	   => 'Home Blocks4',
					'href'     => $this->url->link('extension/module/bhavesh_content', 'token=' . $this->session->data['token'] . '&module_id=65', true),
					'children' => array()		
				);					
			}
