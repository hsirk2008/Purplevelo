...
<div class="tab-pane" id="footer-block1<?php echo $language['language_id']; ?>">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea id="editor-textarea-footer1-<?php echo $language['language_id']; ?>" name="settings[bhavesh][footer_block_1][<?php echo $language['language_id']; ?>]" class="form-control code"><?php echo isset($footer_block_1[$language['language_id']]) ? $footer_block_1[$language['language_id']] : ''; ?></textarea>
    </div>
  </div>
 </div>
 <?php } ?>
...
<div class="form-group">
    ...
    <label><input type="radio" name="settings[bhavesh][overwrite_footer_links]" class="footer-custom-links-select" value="0" <?php if($overwrite_footer_links == '0'){echo ' checked="checked"';} ?> /><span>Disabled</span></label>
    <label><input type="radio" name="settings[bhavesh][overwrite_footer_links]" class="footer-custom-links-select" value="1" <?php if($overwrite_footer_links == '1'){echo ' checked="checked"';} ?> /><span>Enabled</span></label>
    </div>                   
</div>
...
<ul class="nav content-tabs" id="footer-column-tabs">
    ...
    <?php foreach ($bhavesh_footer_columns as $bhavesh_footer_column) { ?>
...
<?php $footer_column_row = 1; ?>
<?php if (!empty($bhavesh_footer_columns)) { ?>
...
<tbody>
  <tr id="column-row<?php echo $footer_column_row; ?>">
    ...
    <input type="text" class="form-control" name="settings[bhavesh][bhavesh_footer_columns][<?php echo $footer_column_row; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($bhavesh_footer_column['title'][$language['language_id']]) ? $bhavesh_footer_column['title'][$language['language_id']] : ''; ?>" />
    </div>
    <?php } ?>
    </td>
    <td class="text-right">
    <input type="text" class="form-control" style="width:60px" name="settings[bhavesh][bhavesh_footer_columns][<?php echo $footer_column_row; ?>][sort]" value="<?php echo isset($bhavesh_footer_column['sort']) ? $bhavesh_footer_column['sort'] : '1'; ?>" />
    </td>
  </tr>
</tbody>
</table>
<table id="links-holder-<?php echo $footer_column_row; ?>" class="table table-clean">
    ...
    <?php if (isset($bhavesh_footer_column['links'])) { ?>
	<?php foreach($bhavesh_footer_column['links'] as $link){ ?>
    <tr id="footer-link-row-<?php echo $footer_column_row; ?>-<?php echo $footer_link_row; ?>">
    <td class="first">
    <?php foreach ($languages as $language) { ?>
    <div class="input-group">
    <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['language_id']; ?>" /></span>
    <input class="form-control" name="settings[bhavesh][bhavesh_footer_columns][<?php echo $footer_column_row; ?>][links][<?php echo $footer_link_row; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($link['title'][$language['language_id']]) ? $link['title'][$language['language_id']] : ''; ?>" />
    </div>
    <?php } ?>
    </td>
    <td class="first">
    <input class="form-control" name="settings[bhavesh][bhavesh_footer_columns][<?php echo $footer_column_row; ?>][links][<?php echo $footer_link_row; ?>][target]" value="<?php echo isset($link['target']) ? $link['target'] : ''; ?>" />
    </td>
    <td class="first">
    <input type="text" class="form-control" style="width:60px" name="settings[bhavesh][bhavesh_footer_columns][<?php echo $footer_column_row; ?>][links][<?php echo $footer_link_row; ?>][sort]" value="<?php echo isset($link['sort']) ? $link['sort'] : '1'; ?>" />
    </td>
    <td class="text-right">
...
<div class="col-sm-10">
  <input class="form-control" name="settings[bhavesh][footer_block_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_block_title[$language['language_id']]) ? $footer_block_title[$language['language_id']] : ''; ?>" />
</div>
</div>
...
<div class="col-sm-10">
  <textarea id="editor-textarea-footer2-<?php echo $language['language_id']; ?>" name="settings[bhavesh][footer_block_2][<?php echo $language['language_id']; ?>]" class="form-control code"><?php echo isset($footer_block_2[$language['language_id']]) ? $footer_block_2[$language['language_id']] : ''; ?></textarea>
</div>
</div>
...
<div class="col-sm-10">
  <input class="form-control" name="settings[bhavesh][footer_infoline_1][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_infoline_1[$language['language_id']]) ? $footer_infoline_1[$language['language_id']] : ''; ?>" />
  <input class="form-control" name="settings[bhavesh][footer_infoline_2][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_infoline_2[$language['language_id']]) ? $footer_infoline_2[$language['language_id']] : ''; ?>" />
  <input class="form-control" name="settings[bhavesh][footer_infoline_3][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_infoline_3[$language['language_id']]) ? $footer_infoline_3[$language['language_id']] : ''; ?>" />
</div>
</div>
...
<div class="form-group">
    ...
    <input type="hidden" name="settings[bhavesh][bhavesh_payment_img]" value="<?php echo $bhavesh_payment_img; ?>" id="input-payment-img" />
    </div>                   
</div>
...
<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Use {year} to add the current year">Footer Copyright Text</span></label>
    ...
    <input class="form-control" name="settings[bhavesh][bhavesh_copyright][<?php echo $language['language_id']; ?>]" value="<?php echo isset($bhavesh_copyright[$language['language_id']]) ? $bhavesh_copyright[$language['language_id']] : ''; ?>" />
    </div>
    <?php } ?>
    </div>
</div>
...
function addFooterColumn() {
	...
	html += '<input type="text" class="form-control" name="settings[bhavesh][bhavesh_footer_columns][' + footer_column_row + '][title][<?php echo $language['language_id']; ?>]" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="text-right">';
	html += '<input type="text" class="form-control" style="width:60px" value="' + footer_column_row + '" name="settings[bhavesh][bhavesh_footer_columns][' + footer_column_row + '][sort]" />';
	html += '</td>';
	html += '</tr>';
	html += '</tbody>';
	html += '</table>';
...
function addFooterLink(footer_column_row) {
	...
	html += '<div class="input-group">';
	html += '<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>';
	html += '<input type="text" class="form-control" name="settings[bhavesh][bhavesh_footer_columns][' + footer_column_row + '][links][' + link_row + '][title][<?php echo $language['language_id']; ?>]" />';
	html += '</div>';
	<?php } ?>
	html += '</td>';
	html += '<td class="first">';
	html += '<input type="text" class="form-control" name="settings[bhavesh][bhavesh_footer_columns][' + footer_column_row + '][links][' + link_row + '][target]" />';
	html += '</td>';
	html += '<td class="first">';
	html += '<input type="text" style="width:60px" class="form-control" name="settings[bhavesh][bhavesh_footer_columns][' + footer_column_row + '][links][' + link_row + '][sort]" value="' + link_row + '" />';
