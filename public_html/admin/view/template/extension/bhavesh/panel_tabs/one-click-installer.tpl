...
<?php if ($theme_default_directory == 'bhavesh' && count($stores) <= 1) { ?>
    <?php if (isset($demos)) { ?>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <img id="demo-preview-img" src="model/extension/bhavesh/demo_stores/1/preview.jpg" /><br /><br />
...
<p>* Stores in the list marked with * will add rules to the Thame Panel's Custom CSS</p>
    ...
    <?php } ?>
<?php } ?>
<?php if ($theme_default_directory != 'bhavesh') { ?>
...
$('select[id=\'demo-store-selector\']').on('change', function () {
    $('#demo-preview-img').attr('src','model/extension/bhavesh/demo_stores/' + $(this).val() + '/preview.jpg');
