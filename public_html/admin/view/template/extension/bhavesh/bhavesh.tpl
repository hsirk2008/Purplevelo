...
<div id="content">
  <div class="page-header">
	...
	<button type="submit" form="form-bhavesh" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary">Save</button>
    <a class="btn btn-default" href="http://bhavesh.openthemer.com/help" target="_blank" data-toggle="tooltip" title="View Theme Documentation">Documentation</a>
    </div>
  ...
  <div class="container-fluid">    
   ...
   <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bhavesh" class="form-horizontal">
   
   <div class="panel-wrapper">
   
   <div class="panel-left">
   <div class="setting-header">v 1.3.0.0</div>
...
$('select[name=\'store_id\']').on('change', function () {
    location = 'index.php?route=extension/bhavesh/bhavesh&token=<?php echo $token; ?>&store_id=' +  encodeURIComponent($(this).val());
});
//--></script>
...
$('#header-preview img').attr('src', 'view/javascript/bhavesh/img/theme-panel/headers/' + $(this).val() + '.png');
});
...
if ($(this).val() == '1') {
	$('#bhavesh_typo_holder').css('display', 'block');
} else {
	$('#bhavesh_typo_holder').css('display', 'none');
}
});
