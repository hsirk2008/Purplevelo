          ...
          <div class="panel panel-default ">
			...
			<?php if ($section['groups'][$group_row]['type'] == 'text' || $section['groups'][$group_row]['type'] == 'button') { ?>
              ...
              <div class="row">
                ...
                <option value="<?php echo $bhavesh_font['name']; ?>" <?php if ($section['groups'][$group_row]['font'] == $bhavesh_font['name']) { echo 'selected="selected"'; } ?>><?php echo $bhavesh_font['name']; ?></option>
                <?php } ?>
              </select>
                </div>
...
function addLayer(section_row, layer_type) {
    ...
    <?php } ?>
	<?php foreach ($bhavesh_fonts as $bhavesh_font) { ?>
	html += '<option value="<?php echo addslashes($bhavesh_font['name']); ?>">';
	html += '<?php echo addslashes($bhavesh_font['name']); ?>';
	html += '</option>';
	<?php } ?>		
	html += '</select>';
	html += '</div>';
