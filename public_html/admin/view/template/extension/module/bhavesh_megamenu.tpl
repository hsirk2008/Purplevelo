                ...
                <div class="background clearfix">
                    ...
                    <?php if($action_type == 'edit') { ?>
                            ...
                            <div class="input clearfix">
                                    ...
                                    <a class="icon_list">Bhavesh Icons</a>
                                    </span>
                            </div>
...
$(document).ready(function() {
        ...
        function menu_updatesort(jsonstring) {
                ...
                if (mittXHRobjekt) {
						...
						ajaxRequest.open("GET", "index.php?route=extension/module/bhavesh_megamenu&token=<?php echo $_GET['token']; ?>&jsonstring=" + encodeURIComponent(jsonstring), true);
	...
	$.ajax({
		...
		success: function(data) {
			...
			html += '      </div>';
			html += '      <div class="modal-body"><iframe src="view/javascript/bhavesh/icons_list/icon_list.html" width="1240" height="560" frameborder="0" allowtransparency="true"></iframe></div>';
			html += '    </div';
			html += '  </div>';
			html += '</div>';
			$('body').append(html);
