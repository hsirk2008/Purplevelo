...
var quickview = function(product_id) {
	$.ajax({
		url: 'index.php?route=extension/bhavesh/quickview&product_id=' + product_id,
		type: 'post',
		dataType: 'html',
		beforeSend: function() {
...
var subscribe = function(module) {
	$.ajax({
		url: 'index.php?route=extension/bhavesh/bhavesh_features/subscribe&module=' + module,
		type: 'post',
		dataType: 'json',
...
var unsubscribe = function(module) {
	$.ajax({
		url: 'index.php?route=extension/bhavesh/bhavesh_features/unsubscribe&module=' + module,
		type: 'post',
		dataType: 'json',
		data: 'email=' + encodeURIComponent($('input[id=\'subscribe-module' + module + '\']').val()),
		success: function(json) {
...
var cart = {
	...
	'remove': function(key) {
		$.ajax({
			url: 'index.php?route=extension/bhavesh/bhavesh_features/remove_from_cart',
			type: 'post',
			data: 'key=' + key,
			dataType: 'json',
			beforeSend: function() {
...
var wishlist = {
	'add': function(product_id) {
		$.ajax({
			url: 'index.php?route=extension/bhavesh/bhavesh_features/add_to_wishlist',
			type: 'post',
...
var compare = {
	'add': function(product_id) {
		$.ajax({
			url: 'index.php?route=extension/bhavesh/bhavesh_features/add_to_compare',
			type: 'post',
			data: 'product_id=' + product_id,
			dataType: 'json',
			success: function(json) {
...
var contact_form_send = function(form_id) {
	$.ajax({
		url: 'index.php?route=extension/bhavesh/bhavesh_features/bhavesh_send_message',
		type: 'post',
		dataType: 'json',
		data: $('#mail_form' + form_id + '').serialize(),
		complete: function() {
			$('#mail_form' + form_id + ' .captchaimg').attr('src', 'index.php?route=extension/bhavesh/bhavesh_features/bhavesh_captcha#'+new Date().getTime());
