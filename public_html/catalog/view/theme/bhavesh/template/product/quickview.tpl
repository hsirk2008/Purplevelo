<div class="table product-info quickview-info hidden-xs" style="height:<?php echo $img_h; ?>px; width:980px;">
    ...
    <?php if ($price) { ?>
      ...
      <div id="product">
          ...
          <button type="button" id="button-cart-quickview" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php if (($qty < 1) && ($stock_badge_status)) { ?><?php echo $bhavesh_text_out_of_stock; ?><?php } else { ?><?php echo $button_cart; ?><?php } ?></button>
          
          
          <a href="<?php echo $product_href; ?>" class="btn btn-outline details"><?php echo $bhavesh_text_view_details; ?></a>
