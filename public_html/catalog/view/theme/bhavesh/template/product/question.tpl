<div class="row">
<div class="col-sm-6">
	<h4><b><?php echo $bhavesh_text_recent_questions; ?></b></h4>
	<div id="question"></div>
</div>
<div class="col-sm-6 right">
<form class="form-horizontal" id="form-question">
    
    <h4 id="ask_heading"><b><?php echo $bhavesh_heading_ask; ?></b></h4>
    
    <div class="form-group required">
      <div class="col-sm-12">
        <label class="control-label" for="input-name"><?php echo $bhavesh_entry_name; ?></label>
    ...
    <div class="form-group required">
      <div class="col-sm-12">
        <label class="control-label" for="input-email"><?php echo $bhavesh_entry_email; ?></label>
    ...
    <div class="form-group required">
      <div class="col-sm-12">
        <label class="control-label" for="input-question"><?php echo $bhavesh_entry_question; ?></label>
    ...
    <div class="form-group required margin-b10">
     ...
     <div class="buttons clearfix">
      <div class="text-right">
        <button type="button" id="button-question" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-outline"><?php echo $bhavesh_button_send; ?></button>
      </div>
    </div>
...
$('#question').load('index.php?route=extension/bhavesh/question/question_list&product_id=<?php echo $product_id; ?>');

$('#button-question').on('click', function() {
	$.ajax({
		url: 'index.php?route=extension/bhavesh/question/ask_question&product_id=<?php echo $product_id; ?>',
		type: 'post',
		dataType: 'json',
		...
		complete: function() {
			...
			$('#captcha_product_questions').attr('src', 'index.php?route=extension/bhavesh/question/question_captcha#'+new Date().getTime());
