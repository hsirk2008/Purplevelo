  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div class="table product-info product-page">
     ...
     <div class="image-area <?php if (!$hover_zoom) { echo "hover-zoom-disabled"; } ?>" id="gallery">
        ...
        <?php if (isset($is_new)) { ?>
        <span class="badge new_badge"><i><?php echo $bhavesh_text_new; ?></i></span>
        <?php } ?>
    ...
    <?php if ($price) { ?>
      ...
      <div id="product">
            ...
            <input type="number" step="1" min="<?php echo $minimum; ?>" name="quantity" value="<?php echo $minimum; ?>" id="input-quantity" class="form-control input-quantity" />
              ...
              <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php if (($qty < 1) && ($stock_badge_status)) { ?><?php echo $bhavesh_text_out_of_stock; ?><?php } else { ?><?php echo $button_cart; ?><?php } ?></button>
            </div>
            <?php if ($minimum > 1) { ?>
    ...
    <p class="info is_ask"><a class="to_tabs" onclick="$('a[href=\'#tab-questions\']').trigger('click'); return false;"><i class="icon-question"></i> <?php echo $bhavesh_button_ask; ?></a></p>
    <?php } ?>
    ...
    <div class="info-holder">
      ...
      <?php if ($bhavesh_share_btn) { ?>
        <?php if ($bhavesh_sharing_style == 'large') { ?>
            <div class="lg-share">
        ...
        <?php } else { ?>
            <p class="info share"><b><?php echo $bhavesh_text_share; ?>:</b> 
...
<div class="col-sm-12">
  ...
  <ul class="nav nav-tabs <?php echo $product_tabs_style; ?> main_tabs">
    ...
    <?php } ?>
    <?php if (!empty($question_status)) { ?>
    <li><a href="#tab-questions" data-toggle="tab"><?php echo $bhavesh_tab_questions; ?> (<?php echo $questions_total; ?>)</a></li>
    <?php } ?>
  </ul>
...
<script src="catalog/view/theme/bhavesh/js/lightgallery/js/lightgallery.min.js"></script>
<script src="catalog/view/theme/bhavesh/js/lightgallery/js/lg-zoom.min.js"></script>
<script src="catalog/view/theme/bhavesh/js/cloudzoom/cloud-zoom.1.0.2.min.js"></script>
<?php if ($bhavesh_price_update) { ?>
<script src="index.php?route=extension/bhavesh/live_options/js&product_id=<?php echo $product_id; ?>"></script>
<?php } ?>
...
<?php } ?>
respondTo:'min',
<?php if ($bhavesh_rel_prod_grid == '5') { ?>
...
<?php if (isset($sale_end_date) && $product_page_countdown) { ?>
 <script>
  ...
  var $this = $(this).html(event.strftime(''
    + '<div class=\"special_countdown\"></span><p><span class=\"icon-clock\"></span> <?php echo $bhavesh_text_offer_ends; ?></p><div>'
    + '%D<i><?php echo $bhavesh_text_days; ?></i></div><div>'
    + '%H <i><?php echo $bhavesh_text_hours; ?></i></div><div>'
    + '%M <i><?php echo $bhavesh_text_mins; ?></i></div><div>'
    + '%S <i><?php echo $bhavesh_text_secs; ?></i></div></div>'));
});
  });
</script>
<?php } ?>
...
$('#button-cart').on('click', function() {
	$.ajax({
		url: 'index.php?route=extension/bhavesh/bhavesh_features/add_to_cart',
		type: 'post',
		data: $('#product input[type=\'text\'], #product input[type=\'number\'], #product input[type=\'hidden\'], #product input[type=\'radio\']:checked, #product input[type=\'checkbox\']:checked, #product select, #product textarea'),
		dataType: 'json',
		beforeSend: function(json) {
			$('body').append('<span class="bhavesh-spinner ajax-call"></span>');
		},
		...
		success: function(json) {
			...
			if (json['error']) {
				$('.bhavesh-spinner.ajax-call').remove();
				...
				if (json['success_redirect']) {
					...
					$('.table-cell').removeClass('has-error');
					$('.alert, .popup-note, .bhavesh-spinner.ajax-call, .text-danger').remove();
