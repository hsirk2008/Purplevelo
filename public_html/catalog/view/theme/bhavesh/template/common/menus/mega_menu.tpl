...
<span class="badge sale_badge"><i><?php echo $bhavesh_text_sale; ?></i></span>
<?php } ?>
...
<a class="icon is_quickview hidden-xs" onclick="quickview('<?php echo $submenu['product']['id']; ?>');" data-toggle="tooltip" data-placement="left" data-title="<?php echo $bhavesh_button_quickview; ?>"><span class="icon-magnifier-add"></span></a>
</div>
</div>
<div class="caption">
...
$(this.el).html(
"<div>" + 
data.days + "<i><?php echo $bhavesh_text_days; ?></i></div><div>" + 
data.hours + " <i><?php echo $bhavesh_text_hours; ?></i></div><div>" + 
data.min + " <i><?php echo $bhavesh_text_mins; ?></i></div><div>" + 
data.sec + " <i><?php echo $bhavesh_text_secs; ?></i></div>");
} 
}); 
});
</script>
