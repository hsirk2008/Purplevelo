...
<div class="top_line">
  <div class="container <?php echo $top_line_width; ?>">
  	<div class="table">
        <div class="table-cell left w60 menu-cell sm-text-center xs-text-center">
            <div class="promo-message"><?php echo $promo_message; ?>
        </div>
...
<div class="sticky-header outer-container header-style">
  <div class="container <?php echo $main_header_width; ?>">
    ...
    <div class="table-cell text-center w60 menu-cell hidden-xs hidden-sm">
        ...
        <div class="main-menu" style="margin-top: -65px;">
            <ul class="categories">
