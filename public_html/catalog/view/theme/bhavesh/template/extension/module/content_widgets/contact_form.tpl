...
<div class="form-group">
  <div class="col-sm-12">
  <label><?php echo $bhavesh_text_name; ?></label>
    <input type="text" name="name" value="" class="form-control" />
  </div>
</div>
<div class="form-group required">
  <div class="col-sm-12">
  <label><?php echo $bhavesh_text_email; ?></label>
    <input type="text" name="email" value="" class="form-control" />
  </div>
</div>
<div class="form-group required">
  <div class="col-sm-12">
  <label><?php echo $bhavesh_text_message; ?></label>
...
<div class="form-group">
<div class="col-sm-12">
  <button type="button" class="btn btn-contrast" onclick="contact_form_send(<?php echo $module; ?>);"><?php echo $bhavesh_text_submit; ?></button>
  </div>
</div>
