<?php
class ModelExtensionBhaveshQuestion extends Model {
	...
	public function addQuestion($product_id, $data) {
		...
		$subject = sprintf($this->language->get('bhavesh_text_subject'), $this->config->get('config_name'));

		$message  = $this->language->get('bhavesh_text_waiting') . "\n";
		$message .= sprintf($this->language->get('bhavesh_text_product_qa'), $this->db->escape(strip_tags($product_info['name']))) . "\n";
		$message .= sprintf($this->language->get('bhavesh_text_author'), $this->db->escape(strip_tags($data['name']))) . " (" . $this->db->escape(strip_tags($data['email'])) . ")" . "\n";
		$message .= $this->language->get('bhavesh_text_question') . "\n";
