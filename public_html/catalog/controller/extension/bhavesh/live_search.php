<?php
class ControllerExtensionBhaveshLiveSearch extends Controller {
	public function index() {
		...
		$json['bhavesh_text_view_all'] = $this->language->get('bhavesh_text_view_all');
		$json['search_url'] = $this->url->link('product/search');
		$json['bhavesh_text_no_result'] = $this->language->get('bhavesh_text_no_result');
