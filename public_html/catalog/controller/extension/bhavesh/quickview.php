<?php
class ControllerExtensionBhaveshQuickview extends Controller {
	public function index() {
		...
		if ($product_info) {
			...
			$data['bhavesh_text_view_details'] = $this->language->get('bhavesh_text_view_details');
			$data['bhavesh_text_select_option'] = $this->language->get('bhavesh_text_select_option');
